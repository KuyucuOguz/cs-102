...
public class MainPageGui extends javax.swing.JFrame {
    ...
    public MainPageGui() {
        ...
        calorieNeed = user1.getCalorieNeed();
        
        EnergyTracker et = new EnergyTracker( user );
        double c = et.getConsumption1();
        double i = et.getIntake1();
        ...
        calorieIntakeBar.setMaximum( (int) calorieNeed );
        calorieIntakeBar.setMinimum(0);
        calorieBurnedBar.setMaximum( (int) calorieNeed);
        ...
        try{
            ...
            calorieIntakeBar.setValue( (int) i );
            calorieBurnedBar.setValue( (int) c );
            connect.close();
        }
        catch( Exception e ) {
    ...
    private void activityButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_activityButtonActionPerformed
        ActivityFrame2 frame2 = new ActivityFrame2(user);
    ...
    private void waterButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_waterButtonActionPerformed
        WaterIntake intake = new WaterIntake(user);
